...
expanded_vars <- c("bac10", "bac08", "perse", "primary_seatbelt_law", "secondary_seatbelt_law", "sl70plus", "graduated_drivers_license_law", "perc14_24", "unemployment_rate", "vehicmilespc")
combined_vars <- c(year_vars_minus_one, expanded_vars)

fn <- as.formula(paste('total_fatalities_rate ~', paste(combined_vars, collapse='+')))

fe_mod <- plm(fn, index="state", data=data, model="within")
summary(fe_mod)
```
...
#To be filled in with FE Coeffs
